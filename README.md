...
Với n sinh viên và B-Tree bậc 3: chiều cao cây <= log2(n+1)/2 => Tìm kiếm rất nhanh khi n lớn.

7. GHI CHÚ
File: QuanLySinhVien.py (1 file duy nhất)
Class BTree: dùng phương pháp "insert-then-split-on-overflow" (tránh lỗi split khi node chỉ có 2 keys)
